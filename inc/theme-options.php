  ...
  $custom_settings = array(
    'contextual_help' => array(
      'content'       => array(
        array(
          ...
          'title'     => __( 'Option Types', 'travelblog' ),
          'content'   => '<p>' . __( 'Help content goes here!', 'travelblog' ) . '</p>'
        )
      ),
      'sidebar'       => '<p>' . __( 'Sidebar content goes here!', 'travelblog' ) . '</p>'
    ),
    'sections'        => array(
      array(
        'id'          => 'home',
        'title'       => __( 'Home Page', 'travelblog' )
      ),
      array(
        'id'          => 'blog',
        'title'       => __( 'Blog', 'travelblog' )
      ),   
      array(
        'title'       =>  __( 'General', 'travelblog' ),
        'id'          => 'general_default'
        ), 
      array(
        'title'       => __( 'Typography', 'travelblog' ),
        'id'          => 'typography'
        ),
      array(
        'id'          => 'header',
        'title'       => __( 'Header', 'travelblog' )
      ),
   
      array(
        'id'          => 'footer',
        'title'       => __( 'Footer', 'travelblog' )
      ),

      array(
        'id'          => 'sidebars',
        'title'       => __( 'Sidebars', 'travelblog' )
      ),    
    ...
    'settings'        => array(
      ...
      /*  array(
        ...
        array(
            'id'          => 'pp-fonts',
            'label'       => __( 'Google Fonts', 'travelblog' ),
            'desc'        => '',
            'std'         => array( 
                array(
                    'family'    => 'montserrat',
        ...
        array(
          'label'       => 'Series Posts style',
          'id'          => 'pp_series_posts_style',
          'type'        => 'select',
          'desc'        => '',
          'choices'     => array(
            array('label'  => 'Standard','value' => 'std'),
        ...
        array(
          'label'       => 'Next/prev post navigation thumbnail links at the end of posts.',
          'id'          => 'wpnavthumbs',
          'type'        => 'on_off',
          'desc'        => 'Set ON to show post thumbnails, set OFF to hide.',
          'std'         => 'on',
          'rows'        => '',
          'post_type'   => '',
          'taxonomy'    => '',
