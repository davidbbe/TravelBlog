...
function _custom_meta_boxes() {
  ...
  $meta_box_layout = array(
    ...
    'title'     => __('Layout','travelblog'),
    'desc'      => __('You can choose a sidebar from the list below. Sidebars can be created in the Theme Options and configured in the Appearance -> Widgets.','travelblog'),
    'pages'     => array( 'post' ),
    'context'   => 'normal',
    'priority'  => 'high',
    'fields'    =>   array(
      ...
      array(
        'id'          => 'pp_post_type',
        'label'       => __('Post lead section type','travelblog'),
        'desc'        => '',
        'std'         => 'map',
        'type'        => 'select',
        'class'       => '',
        'choices'     => array(
          array(
            'value'   => 'map',
            'label'   => __('Map','travelblog')
            ),
          array(
            'value'   => 'photo',
            'label'   => __('Full width photo','travelblog'),
            ),          
          array(
            'value'   => 'standard',
            'label'   => __('Simple header','travelblog'),
            ),
          ),
        ),
      array(
  ...
  'fields'    => array(
    array(
      ...
      'choices'     => array(
        array(
          'value'   => 'left-sidebar',
          'label'   => __('Left Sidebar','travelblog'),
          'src'     => OT_URL . '/assets/images/layout/left-sidebar.png'
          ),
        array(
          'value'   => 'right-sidebar',
          'label'   => __('Right Sidebar','travelblog'),
          'src'     => OT_URL . '/assets/images/layout/right-sidebar.png'
          ),
        array(
          'value'   => 'full-width',
          'label'   => __('Full Width (no sidebar)','travelblog'),
          'src'     => OT_URL . '/assets/images/layout/full-width.png'
          )
        ),
      ),
...
$parallax = array(
  ...
  'fields'    => array(
    ...
    array(
        'id'          => 'pp_page_map_type',
        'label'       => __('Which map you want to display','travelblog'),
        'desc'        => '',
        'std'         => 'main',
        'type'        => 'select',
        'class'       => '',
        ...
        'choices'     => array(
          array(
            'value'   => 'pagemap',
            'label'   => __('This Page\'s map','travelblog')
            ),
          array(
            'value'   => 'global',
            'label'   => __('Global map','travelblog')
            ),
          array(
            'value'   => 'custom',
            'label'   => __('Custom Map','travelblog'),
            ),          
          ),
        ),
    array(
